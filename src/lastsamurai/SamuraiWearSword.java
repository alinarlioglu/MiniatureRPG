...
public class SamuraiWearSword extends Walker {
    ...
    private static final Shape SAMURAI_SWORD = new PolygonShape(-0.41f,2.37f, -0.79f,1.71f, -0.78f,-0.17f, -0.55f,-2.45f, 0.67f,-2.44f, 0.8f,-0.13f, 0.71f,1.72f, 0.33f,2.39f);    
    ...
    public SamuraiWearSword(GameWorld w) {
        super(w);
        SolidFixture samurai = new SolidFixture(this, SAMURAI_SWORD, 1);
